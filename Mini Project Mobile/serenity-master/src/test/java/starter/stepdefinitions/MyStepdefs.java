...
public class MyStepdefs {
    ...
    @And("{actor} input valid register username {string}")
    public void userInputValidRegisterUsername(Actor actor, String username) {
    }

    @And("{actor} input invalid register username {string}")
    public void userInputInvalidRegisterUsername(String arg0) {
    }
}